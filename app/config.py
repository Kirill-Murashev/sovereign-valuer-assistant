...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        data_hub_dir=os.getenv("SVA_DATA_HUB_DIR", "data_hub"),
        chunk_size=_as_int(os.getenv("SVA_CHUNK_SIZE"), 800),
        chunk_overlap=_as_int(os.getenv("SVA_CHUNK_OVERLAP"), 100),
        top_k=_as_int(os.getenv("SVA_TOP_K"), 5),
        allow_memory_write=_as_bool(os.getenv("SVA_ALLOW_MEMORY_WRITE"), False),
        allow_network_tools=_as_bool(os.getenv("SVA_ALLOW_NETWORK_TOOLS"), False),
    )
